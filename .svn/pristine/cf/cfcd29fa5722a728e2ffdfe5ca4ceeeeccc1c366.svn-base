...
public class WifiAdmin {  
	private final String TAG = "WifiAdmin-LOG";
    // 定义WifiManager对象   
...
//然后是一个实际应用方法，只验证过没有密码的情况： 
    ...
    {  
    	Log.d(TAG, "SSID: " + SSID + " pwd: " + Password + " type: " + Type);
    	Log.d(TAG, "CreateWifiInfo...CONNECTING...");
    ...
    {   
        List<WifiConfiguration> existingConfigs = mWifiManager.getConfiguredNetworks();   
           ...
           {   
        	   Log.d(TAG, "existingConfig.SSID：" + existingConfig.SSID + " " + existingConfig.status);
