...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private OnTabSelectListener tabSelctListener;
		...
		tab.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				try{
					...
					if(tabSelctListener != null){
						tabSelctListener.onTabSelected(position);
					}
				}catch(Exception e){
					e.printStackTrace();
				}
	...
	public void setCurrentTab(int currentPosition) {
	...
	private void scrollToChild(int position, int offset) {
		...
		if(position > tabsContainer.getChildCount()-1){
			position = tabsContainer.getChildCount() - 1;
...
//			Log.i("POSITION", "currentPosition: " + currentPosition);
	...
	public OnTabSelectListener getTabSelctListener() {
		return tabSelctListener;
	}

	public void setTabSelctListener(OnTabSelectListener tabSelctListener) {
		this.tabSelctListener = tabSelctListener;
	}
