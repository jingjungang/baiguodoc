package com.ukang.baiyu.view.slidingmenu;

import java.util.ArrayList;
import java.util.List;

import com.ukang.baiyu.view.slidingmenu.SlidingMenu.OnClosedListener;
import com.ukang.baiyu.view.slidingmenu.SlidingMenu.OnOpenedListener;
...
//		FragmentChangeActivity.changeStatusBar(item);
	}
