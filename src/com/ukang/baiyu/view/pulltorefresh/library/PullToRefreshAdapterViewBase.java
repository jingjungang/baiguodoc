...
import com.ukang.baiyu.view.pulltorefresh.library.internal.EmptyViewMethodAccessor;
import com.ukang.baiyu.view.pulltorefresh.library.internal.IndicatorLayout;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	...
	public void setSelection(int position) {
		((AdapterView<ListAdapter>) mRefreshableView).setSelection(position);
	}
